...
if 'personal' not in profiles or 'work' not in profiles:
    sys.exit(1)
personal_model = cfg.get('profiles', {}).get('personal', {}).get('[opencode]', {}).get('agents', {}).get('sisyphus', {}).get('model', '')
if not personal_model:
    personal_model = cfg.get('[opencode]', {}).get('agents', {}).get('sisyphus', {}).get('model', '')
work_model = cfg.get('profiles', {}).get('work', {}).get('[opencode]', {}).get('agents', {}).get('sisyphus', {}).get('model', '')
if not personal_model or not work_model:
    sys.exit(1)
personal_models = {**cfg.get('models', {}), **cfg.get('profiles', {}).get('personal', {}).get('models', {})}
if personal_model in personal_models:
    personal_model = personal_models[personal_model].get('model', '')
work_models = {**cfg.get('models', {}), **cfg.get('profiles', {}).get('work', {}).get('models', {})}
if work_model in work_models:
    work_model = work_models[work_model].get('model', '')
