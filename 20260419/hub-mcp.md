...
For more information about MCP concepts and how MCP servers work, see the [Docker MCP Catalog and Toolkit](/ai/mcp-catalog-and-toolkit/hub-mcp/) overview page.
...
> [!TIP]
> By default, the Gordon [client](/ai/mcp-catalog-and-toolkit/toolkit/#install-an-mcp-client) is enabled,
