...
> [!NOTE]
> When using the images with [Docker MCP gateway](/ai/mcp-catalog-and-toolkit/mcp-gateway/),
...
The [catalog](/ai/mcp-catalog-and-toolkit/catalog/) is the source of
available MCP servers - a library of tools you can choose from.
[Profiles](/ai/mcp-catalog-and-toolkit/profiles/) are collections of
...
- [Open-source MCP Gateway](/ai/mcp-catalog-and-toolkit/mcp-gateway/)
