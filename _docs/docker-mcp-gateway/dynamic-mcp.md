...
[MCP Catalog](/ai/mcp-catalog-and-toolkit/catalog/) and add servers
as needed.

This capability is enabled automatically when you connect an MCP client to the
[MCP Toolkit](/ai/mcp-catalog-and-toolkit/toolkit/). The gateway
...
[MCP Toolkit](/ai/mcp-catalog-and-toolkit/toolkit/) or
[Profiles](/ai/mcp-catalog-and-toolkit/profiles/) are available.

## Prerequisites

To use Dynamic MCP, you need:

- Docker Desktop version 4.50 or later, with [MCP Toolkit](/ai/mcp-catalog-and-toolkit/toolkit/) enabled
...
See [Get started with Docker MCP Toolkit](/ai/mcp-catalog-and-toolkit/get-started/)
...
Toolkit to search for SQL-related servers in the [MCP Catalog](/ai/mcp-catalog-and-toolkit/catalog/).
