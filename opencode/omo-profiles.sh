...
function omo-set-profile() {
  ...
  case $profile in
    "hybrid") # 最強のハイブリッド：品質とエージェント能力のベストミックス
      ...
      export DEEP_MODEL="opencode/glm-5"
      export VISUAL_MODEL="google/gemini-3.1-pro"
      export QUICK_MODEL="opencode/minimax-m2.5"
    ...
    "reasoning") # 深考モード：難解なバグ修正、アルゴリズム設計、複雑なリサーチ
      ...
      export DEEP_MODEL="opencode/kimi-k2.5"
      export VISUAL_MODEL="google/gemini-3.1-pro"
    ...
    "frontier-asia") # アジア・フロンティア：高速、多機能、コスト効率
      export ULTRABRAIN_MODEL="opencode/glm-5"
      export CRAFTSMAN_MODEL="opencode/minimax-m2.5"
      export DEEP_MODEL="opencode/kimi-k2.5"
      export VISUAL_MODEL="opencode/mimo-v2-omni"
      export QUICK_MODEL="opencode/mimo-v2-flash"
    ...
    "creative-ui") # UI/UX 開発：デザインの正確性とマルチモーダル検証
      ...
      export DEEP_MODEL="opencode/mimo-v2-pro"
      export VISUAL_MODEL="opencode/mimo-v2-omni"
